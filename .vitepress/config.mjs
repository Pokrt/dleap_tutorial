    ...
    themeConfig: {
        ...
        sidebar: [
            ...
            },
            {
                ...
                items:
                    [
                        {text: 'Application', link: 'items/application'},
                        {text: 'Form', link: 'items/Form'},
                        {text: 'Page', link: 'items/page'},
                        {text: 'App Page', link: 'items/appPage'},
                        {
                            text: 'Item Objects',
                            collapsed: true,
                            items: [
                        ...
                        {text: 'Data Object', link: 'low-code-basics/data_objects'},
                        {text: 'Service', link: 'low-code-basics/service_object'},
                        {text: 'Action Button', link: 'low-code-basics/action_button'},
